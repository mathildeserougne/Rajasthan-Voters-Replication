...
panel_A_summary_2 <- create_summary_table_2(results_list1, "Panel A: Average Effects")
panel_B_summary_2 <- create_summary_table_2(results_list2, "Panel B: Effects by Type of Campaign")
