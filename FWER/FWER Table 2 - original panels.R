# FWER method on Table 2 (Performance), using the original sample splitting.
# One panel with and one panel without gender reservation.
    ...
    if (!is.null(model)) {
      ...
      for (var in var_names) {
        if (var %in% rownames(coef_table)) {
          ...
          # if you want to keep the significance stars
