...
# comparing the controls chosen for the initial (baseline) stata code and dl selection
 install.packages(c("tidyverse","glmnet","sandwich","lmtest","car","modelsummary","broom"))
...
# NOUVELLE LISTE COMPLÈTE DES CONTRÔLES CANDIDATS
full_controls_candidates <- c(
  # Liste baseline (inchangée)
  ...
  # Ajouts : CHAL00 (pré-traitement)
  "CHAL00_nbchal", "CHAL00_prop_female", "CHAL00_prop_sc", "CHAL00_prop_st",
  # "CHAL00_prop_loweduc", trop de na
  "CHAL00_prop_exsarpanch", "CHAL00_prop_candbefore",
  "CHAL00_prop_exwardpanch",
  
  # Ajouts : Économie/Emploi (pré-2010)
  "web_hh_employed2009", "web_persondays_total2009", "log_web_persondays_total2009",
  
  # Ajouts : Élections (ELEC05, pré-traitement)
  #"ELEC05_nbfemalecandidates", "ELEC05_nbmalecandidates", "ELEC05_nbcandidates",
  # trop de NA
  
  # Ajouts : Indices composites
  "index_empl_pre_svysample",
  # "index_asset_pre", trop de na
  "index_opinion_pre",
...
double_lasso_fit <- function(data_df,
  ...
  # Filtrer les lignes avec NA dans X_mat ou fe_mat
...
for (i in seq_along(incum_dep_vars1)) {
  ...
  results <- double_lasso_fit(
    ...
    x_candidates = full_controls_candidates,  # <-- LISTE COMPLÈTE ICI
